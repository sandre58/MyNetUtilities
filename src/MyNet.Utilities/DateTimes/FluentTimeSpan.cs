...
namespace MyNet.Utilities.DateTimes
{
        ...
        IComparable<FluentTimeSpan>
    {
        ...
        public readonly FluentTimeSpan Add(FluentTimeSpan number) => AddInternal(this, number);
        ...
        /// <returns>The result of the addition.</returns>
        public readonly FluentTimeSpan Add(TimeSpan timeSpan) => AddInternal(this, timeSpan);
        ...
        public readonly FluentTimeSpan Subtract(FluentTimeSpan fluentTimeSpan) => SubtractInternal(this, fluentTimeSpan);
        ...
        /// <returns>The result of the subtraction.</returns>
        public readonly FluentTimeSpan Subtract(TimeSpan timeSpan) => SubtractInternal(this, timeSpan);
        ...
        /// <inheritdoc />
        public override readonly string ToString() => ((TimeSpan)this).ToString();
        ...
        /// </returns>
        public readonly bool Equals(FluentTimeSpan other) => this == other;
        ...
        /// <inheritdoc />
        public override readonly int GetHashCode() => Months.GetHashCode() ^ Years.GetHashCode() ^ TimeSpan.GetHashCode();

        private static FluentTimeSpan AddInternal(FluentTimeSpan left, TimeSpan right) => new()
        {
            Months = left.Months,
            Years = left.Years,
        ...
        private static FluentTimeSpan SubtractInternal(FluentTimeSpan left, TimeSpan right) => new()
        {
            Months = left.Months,
            Years = left.Years,
            TimeSpan = left.TimeSpan - right
        ...
        /// </summary>
        public readonly long Ticks => ((TimeSpan)this).Ticks;

        public readonly int Days => ((TimeSpan)this).Days;

        public readonly int Hours => ((TimeSpan)this).Hours;

        public readonly int Milliseconds => ((TimeSpan)this).Milliseconds;

        public readonly int Minutes => ((TimeSpan)this).Minutes;

        public readonly int Seconds => ((TimeSpan)this).Seconds;

        public readonly double TotalDays => ((TimeSpan)this).TotalDays;
        public readonly double TotalHours => ((TimeSpan)this).TotalHours;
        public readonly double TotalMilliseconds => ((TimeSpan)this).TotalMilliseconds;
        public readonly double TotalMinutes => ((TimeSpan)this).TotalMinutes;
        public readonly double TotalSeconds => ((TimeSpan)this).TotalSeconds;

        public readonly int CompareTo(TimeSpan other) => ((TimeSpan)this).CompareTo(other);

        public readonly int CompareTo(object value) => value is TimeSpan timeSpan
                ? ((TimeSpan)this).CompareTo(timeSpan)
                : throw new ArgumentException("Value must be a TimeSpan", nameof(value));

        public readonly int CompareTo(FluentTimeSpan other) => ((TimeSpan)this).CompareTo(other);
