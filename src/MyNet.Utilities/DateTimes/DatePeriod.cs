...
namespace MyNet.Utilities.DateTimes
{
    ...
    {
        public DatePeriod(DateOnly start, DateOnly end) : base(start, end) { }
    ...
    {
        public ImmutableDatePeriod(DateOnly start, DateOnly end) : base(start, end) { }
    ...
    {
        public DatePeriodWithOptionalEnd(DateOnly start, DateOnly? end = null) : base(start, end) { }
