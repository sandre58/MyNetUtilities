...
namespace MyNet.Utilities.Helpers
{
    public static class TypeHelper
    {
        ...
        public static string GetAssemblyNameWithoutOverhead(string fullyQualifiedAssemblyName)
        {
            ...
            return indexOfFirstComma != -1 ? fullyQualifiedAssemblyName.Substring(0, indexOfFirstComma) : fullyQualifiedAssemblyName;
        }
        ...
        public static Type? GetTypeFrom(string valueType)
        {
            ...
            var assemblies = AppDomain.CurrentDomain.GetAssemblies().Except(new[] { entryAssembly });
