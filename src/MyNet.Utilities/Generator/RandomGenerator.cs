...
namespace MyNet.Utilities.Generator
{
    public static class RandomGenerator
    {
        ...
        public static string PhoneNumber()
        {
            ...
            _ = str.Append(string.Join("", Digits(9)));
        ...
        /// </summary>
        public static T ListItem<T>(List<T> list) => ListItem(list as IList<T>);
        ...
        /// <param name="items">The source of items to pick from.</param>
        /// <param name="count">The number of items to pick; otherwise, a random amount is picked.</param>
        public static IList<T> ListItems<T>(List<T> items, int? count = null) => ListItems(items as IList<T>, count);
        ...
        public static string ReplaceFormat(string format) => ReplaceSymbols(format, ['*', '#', '?'], x =>
                                                                      {
                                                                          ...
                                                                          return x == '#' ? Convert.ToChar('0' + Number(9)) : x == '?' ? Convert.ToChar('A' + Number(25)) : x;
                                                                      });
        ...
        public static string ClampString(string str, int? min = null, int? max = null)
        {
            ...
            if (min != null && min > str.Length)
            {
                ...
                var fillerChars = ReplaceFormat("".PadRight(missingChars.Value, '?'));
        ...
        public static string Color() => $"#{Seed.Next(0x1000000):X6}";

        public static Country Country() => ListItem(Enumeration.GetAll<Country>());
    }
}
