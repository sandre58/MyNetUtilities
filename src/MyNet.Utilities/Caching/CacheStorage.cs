...
namespace MyNet.Utilities.Caching
{
    ...
    {
        #region Fields
        private readonly Func<ExpirationPolicy>? _defaultExpirationPolicyInitCode = defaultExpirationPolicyInitCode;
